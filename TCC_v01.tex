...
% Os autores nas referências, incluir % no início do comando acima e retirar a % do comando abaixo 

%\usepackage[alf,abnt-emphasize=bf, abnt-thesis-year=both, abnt-repeated-author-omit=yes, abnt-last-names=abnt, abnt-etal-cite,abnt-etal-list=0, abnt-etal-text=default, abnt-and-type=e,bibjustif]{abntex2cite}
% ---
% Sistema Numérico
% ---
% Para citações numéricas, incluir % no início do comando acima e retirar a % do comando abaixo 
...
% Há diversas opções para nota de rodapé no Sistema Numérico.  
...
% Quando for adotado o Sistema Numérico, habilite-o
...
% Use \professor para Definir como professor e \orientadora para definir orientadora
...
\makeatletter
% Configurações de aparência do PDF final (MUDE DE RED E BLUE PARA BLACK NA IMPRESSÃO FINAL)
\hypersetup{
	%pagebackref=true,
	pdftitle={\@title}, 
	pdfauthor={\@author},
